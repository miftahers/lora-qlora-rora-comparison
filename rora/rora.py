...
output_dir = "./results"
logging_dir = "./logs"
trained_model_name = "bert-lora-squad"
...
seeds =  [42, 1234, 2023, 2024, 2025]  # List of seeds to test
final_results = []
...
for seed in seeds:
    ...
    set_seed(seed)  # Set a seed for reproducibility
    ...
    try:
        ...
        continue  # Skip to the end of the script if evaluation fails
    finally:
